...
- Обновлен встроенный плеер (библиотека VLC) и исправлена перемотка при воспроизведении формата WEBM (YouTube)
...
- Избранное: исправлено открытие плейлиста по ссылке без открытия раздела, ручное добавление и редактирование ссылок в плейлисте, для создания плейлиста используется пункт "Добавить" меню приложения
